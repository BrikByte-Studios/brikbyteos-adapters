			...
			Issues: []normalizedIssue{
				{
					...
					Message: nonEmpty(raw.RunResult.ErrorMessage, "trivy adapter unavailable"),
				},
			},
		},
			...
			Issues: []normalizedIssue{
				{
					...
					Message: nonEmpty(raw.RunResult.ErrorMessage, "trivy execution timed out"),
				},
			},
		},
		Artifacts: normalizedArtifacts{
			...
			Issues: []normalizedIssue{
				{
					...
					Message: "trivy tool output missing",
				},
			},
		},
		Artifacts: normalizedArtifacts{
